        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <<h2>Features</h2>
                        <p>
                            KafeKotaKita hadir dengan fitur-fitur cerdas untuk membantu kamu menemukan kafe favorit
                            dengan
                            cepat dan mudah.
                        ...
                        <div class="feature-list">
                            ...
                            <div class="feature-item" onclick="toggleDetail(this, 'reservations')">
                                ...
                                <div class="feature-description" id="reservations" style="display: none;">
                                    <p>
                                        Ingin memastikan tempatmu tersedia? Lakukan reservasi langsung dari aplikasi
                                        tanpa
